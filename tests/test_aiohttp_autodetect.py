...
class TestMakeDefaultAsyncClientWithoutAiohttp(unittest.TestCase):
    ...
    def test_returns_httpx_async_client(self) -> None:
        ...
        with mock.patch.dict(sys.modules, {"httpx_aiohttp": None}):
            from auth0.myorganization.client import _make_default_async_client
    ...
    def test_explicit_httpx_client_bypasses_autodetect(self) -> None:
        ...
        with mock.patch("auth0.myorganization.client._make_default_async_client") as mock_make:
...
class TestDefaultClientsWithoutAiohttp(unittest.TestCase):
    ...
    def test_default_async_httpx_client_defaults(self) -> None:
        ...
        from auth0.myorganization._default_clients import SDK_DEFAULT_TIMEOUT, DefaultAsyncHttpxClient
    ...
    def test_default_async_httpx_client_overrides(self) -> None:
        ...
        from auth0.myorganization._default_clients import DefaultAsyncHttpxClient
    ...
    def test_default_aiohttp_client_raises_without_package(self) -> None:
        ...
        import auth0.myorganization._default_clients

        with mock.patch.dict(sys.modules, {"httpx_aiohttp": None}):
            importlib.reload(auth0.myorganization._default_clients)

            with self.assertRaises(RuntimeError) as ctx:
                auth0.myorganization._default_clients.DefaultAioHttpClient()
            self.assertIn("pip install myorganization-python[aiohttp]", str(ctx.exception))
...
class TestDefaultClientsWithAiohttp(unittest.TestCase):
    ...
    def test_default_aiohttp_client_defaults(self) -> None:
        ...
        from auth0.myorganization._default_clients import SDK_DEFAULT_TIMEOUT, DefaultAioHttpClient
