...
def test_organization_identityProviders_provisioning_get() -> None:
    ...
    client.organization.identity_providers.provisioning.get(idp_id="idp_id")
...
def test_organization_identityProviders_provisioning_create() -> None:
    ...
    client = get_client(test_id)
    client.organization.identity_providers.provisioning.create(idp_id="idp_id")
...
def test_organization_identityProviders_provisioning_delete() -> None:
    ...
    client = get_client(test_id)
    client.organization.identity_providers.provisioning.delete(idp_id="idp_id")
...
def test_organization_identityProviders_provisioning_update_attributes() -> None:
    ...
    client = get_client(test_id)
    client.organization.identity_providers.provisioning.update_attributes(idp_id="idp_id", request={"key": "value"})
