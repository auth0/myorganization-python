...
class InvitationsClient:
    ...
    def delete(
        ...
        """
        _response = self._raw_client.delete(invitations=invitations, request_options=request_options)
        return _response.data
...
class AsyncInvitationsClient:
    ...
    async def delete(
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.delete(invitations=invitations, request_options=request_options)
        return _response.data
