...
class IdpOidcResponse(UniversalBaseModel):
    """
    Identity provider specific options.
    """

    strategy: IdpOidcResponseStrategy
    options: typing.Optional[IdpOidcOptionsResponse] = pydantic.Field(default=None)
    """
    Identity provider specific options.
    """

    attributes: typing.Optional[typing.List[IdpUserAttributeMapItem]] = None
