...
class IdpSamlpOptionsRequestMetadataUrl(UniversalBaseModel):
    ...
    signing_cert: typing_extensions.Annotated[
        ...
        pydantic.Field(
            alias="signingCert",
            description="Signing certificate (encoded in PEM or CER) you retrieved from the IdP. Optional for this variant: when omitted, the certificate is read from the metadata document.",
        ),
    ] = None
